# Coldline Task 1.2 — AI exception-path tracing

[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/tripleten-com/ai-system-engineering-curriculum-sprint-1-task-1-2/tree/main)
...
For Task 1.2, `poe verify` runs readiness, smoke tests, the end-to-end workflow, and
...
Use the Task 1.2 lesson to decide what evidence to collect. This README covers local setup and
